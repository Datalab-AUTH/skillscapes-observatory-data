...
df_attica = extract_employment_data("Attica_Region_ENG-7.xlsx")
df_central_greece = extract_employment_data("Central_Greece_Region_ENG-4.xlsx")
df_central_macedonia = extract_employment_data("Central_Macedonia_Region_ENG-5.xlsx")
df_crete = extract_employment_data("Crete_Region_ENG-3.xlsx")
df_eastern_macedonia = extract_employment_data("Eastern_Macedonia-Thrace_Region_ENG-5.xlsx")
df_epirus = extract_employment_data("Epirus_Region_ENG-4.xlsx")
df_ionian_islands = extract_employment_data("Ionian_Islands_Region_ENG-4.xlsx")
df_north_aegean = extract_employment_data("North_Aegean_Region_ENG-5.xlsx")
df_peloponnese = extract_employment_data("Peloponnese_Region_ENG-4.xlsx")
df_south_aegean = extract_employment_data("South_Aegean_Region_ENG_-1.xlsx")
df_thessaly = extract_employment_data("Thessaly_Region_ENG-5.xlsx")
df_western_greece = extract_employment_data("Western_Greece_Region_ENG-4.xlsx")
df_western_macedonia = extract_employment_data("Western_Macedonia_Region_ENG-6.xlsx")
