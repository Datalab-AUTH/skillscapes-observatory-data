...
df_attica = extract_keyfigure_data("Attica_Region_ENG-7.xlsx")
df_central_greece = extract_keyfigure_data("Central_Greece_Region_ENG-4.xlsx")
df_central_macedonia = extract_keyfigure_data("Central_Macedonia_Region_ENG-5.xlsx")
df_crete = extract_keyfigure_data("Crete_Region_ENG-3.xlsx")
df_eastern_macedonia = extract_keyfigure_data("Eastern_Macedonia-Thrace_Region_ENG-5.xlsx")
df_epirus = extract_keyfigure_data("Epirus_Region_ENG-4.xlsx")
df_ionian_islands = extract_keyfigure_data("Ionian_Islands_Region_ENG-4.xlsx")
df_north_aegean = extract_keyfigure_data("North_Aegean_Region_ENG-5.xlsx")
df_peloponnese = extract_keyfigure_data("Peloponnese_Region_ENG-4.xlsx")
df_south_aegean = extract_keyfigure_data("South_Aegean_Region_ENG_-1.xlsx")
df_thessaly = extract_keyfigure_data("Thessaly_Region_ENG-5.xlsx")
df_western_greece = extract_keyfigure_data("Western_Greece_Region_ENG-4.xlsx")
df_western_macedonia = extract_keyfigure_data("Western_Macedonia_Region_ENG-6.xlsx")
