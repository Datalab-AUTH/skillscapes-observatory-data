...
df_attica = extract_hotel_capacity("Attica_Region_ENG-7.xlsx")
df_central_greece = extract_hotel_capacity("Central_Greece_Region_ENG-4.xlsx")
df_central_macedonia = extract_hotel_capacity("Central_Macedonia_Region_ENG-5.xlsx")
df_crete = extract_hotel_capacity("Crete_Region_ENG-3.xlsx")
df_eastern_macedonia = extract_hotel_capacity("Eastern_Macedonia-Thrace_Region_ENG-5.xlsx")
df_epirus = extract_hotel_capacity("Epirus_Region_ENG-4.xlsx")
df_ionian_islands = extract_hotel_capacity("Ionian_Islands_Region_ENG-4.xlsx")
df_north_aegean = extract_hotel_capacity("North_Aegean_Region_ENG-5.xlsx")
df_peloponnese = extract_hotel_capacity("Peloponnese_Region_ENG-4.xlsx")
df_south_aegean = extract_hotel_capacity("South_Aegean_Region_ENG_-1.xlsx")
df_thessaly = extract_hotel_capacity("Thessaly_Region_ENG-5.xlsx")
df_western_greece = extract_hotel_capacity("Western_Greece_Region_ENG-4.xlsx")
df_western_macedonia = extract_hotel_capacity("Western_Macedonia_Region_ENG-6.xlsx")
