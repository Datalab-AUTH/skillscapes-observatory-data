...
def extract_overnight_data(path_to_xlsx):
    ...
    # Locate the header row (the row where column A == "Regional Unit")
    ...
    for header_row in header_row_ids:
        ...
        # Extract the REGION_NAME (cell A3)
        cell_region_name = str(df.at[header_row - 1, 0])  # A3 is row index 2, col index 0
...
df_attica = extract_overnight_data("Attica_Region_ENG-7.xlsx")
df_central_greece = extract_overnight_data("Central_Greece_Region_ENG-4.xlsx")
df_central_macedonia = extract_overnight_data("Central_Macedonia_Region_ENG-5.xlsx")
df_crete = extract_overnight_data("Crete_Region_ENG-3.xlsx")
df_eastern_macedonia = extract_overnight_data("Eastern_Macedonia-Thrace_Region_ENG-5.xlsx")
df_epirus = extract_overnight_data("Epirus_Region_ENG-4.xlsx")
df_ionian_islands = extract_overnight_data("Ionian_Islands_Region_ENG-4.xlsx")
df_north_aegean = extract_overnight_data("North_Aegean_Region_ENG-5.xlsx")
df_peloponnese = extract_overnight_data("Peloponnese_Region_ENG-4.xlsx")
df_south_aegean = extract_overnight_data("South_Aegean_Region_ENG_-1.xlsx")
df_thessaly = extract_overnight_data("Thessaly_Region_ENG-5.xlsx")
df_western_greece = extract_overnight_data("Western_Greece_Region_ENG-4.xlsx")
df_western_macedonia = extract_overnight_data("Western_Macedonia_Region_ENG-6.xlsx")
