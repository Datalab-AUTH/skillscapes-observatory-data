...
d_eu_labour_sector_employment <- d_eu_labour_sector_employment |>
  ...
  mutate(
    ...
    sector_jklmnu_prev_year = lag(sector_jklmnu_country),
    sector_opq_prev_year = lag(sector_opq_country),
    sector_rst_prev_year = lag(sector_rst_country),
    ...
    IM_sector_a = sector_a_prev_year * ((sector_a - sector_a_prev_year)/ sector_a_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_bde = sector_bde_prev_year * ((sector_bde - sector_bde_prev_year)/ sector_bde_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_c = sector_c_prev_year * ((sector_c - sector_c_prev_year) / sector_c_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_f = sector_f_prev_year * ((sector_f - sector_f_prev_year) / sector_f_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_g = sector_g_prev_year * ((sector_g - sector_g_prev_year) / sector_g_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_h = sector_h_prev_year * ((sector_h - sector_h_prev_year) / sector_h_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_i = sector_i_prev_year * ((sector_i - sector_i_prev_year) / sector_i_prev_year) - ((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_jklmnu = sector_jklmnu_prev_year * ((sector_jklmnu - sector_jklmnu_prev_year)/ sector_jklmnu_prev_year)-((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_opq = sector_opq_prev_year * ((sector_opq - sector_opq_prev_year)/ sector_opq_prev_year)-((total_employment - total_employment_prev_year) / total_employment_prev_year),
    IM_sector_rst = sector_rst_prev_year * ((sector_rst - sector_rst_prev_year)/ sector_rst_prev_year)-((total_employment - total_employment_prev_year) / total_employment_prev_year),
    ...
    RS_sector_jklpmnu = sector_jklpmnu_prev_year * ((sector_jklpmnu - sector_jklpmnu_prev_year) / sector_jklpmnu_prev_year) - ((sector_jklpmnu_country - sector_jklpmnu_country_prev_year) / sector_jklpmnu_country_prev_year),
