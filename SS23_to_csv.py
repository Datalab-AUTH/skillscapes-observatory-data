...
def merge_two_excels(file1, file2, output_csv):
    # Read both files
    df1 = read_excel_long(file1).rename(columns={"Value": "Value1"})
    df2 = read_excel_long(file2).rename(columns={"Value": "Value2"})
...
# Example usage:
merge_two_excels("data_original/SS23-εστίαση.xlsx", "data_original/SS23-καταλύματα.xlsx", "data_csv/SS23.csv")
